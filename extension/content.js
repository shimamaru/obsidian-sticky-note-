(function () {
  ...
  const overlay  = document.getElementById('obs-sticky-overlay');
  ...
  header.addEventListener('mousedown', e => {
    if (locked || e.target.closest('#obs-sticky-lock')) return;
    mode = 'drag';
  ...
  panel.querySelectorAll('.obs-rh').forEach(el => {
    el.addEventListener('mousedown', e => {
      ...
      startOp(getComputedStyle(el).cursor);
